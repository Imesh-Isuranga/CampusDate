...
import { Subscription as StompSubscription } from 'stompjs'; // Import StompSubscription to differentiate from rxjs Subscription
...
export class ChatComponent implements OnInit, OnDestroy {
  ...
  stompUserSub: StompSubscription  | undefined;
  ...
  stompConvSub: StompSubscription  | undefined;
